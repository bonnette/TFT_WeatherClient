...
display_date = tk.Label(tk_root, font=(FONT_NAME, SM_FONT_SIZE, FONT_STYLE), fg=FG_COLOR_DATE, bg=BG_COLOR_ROOT)
display_date.pack()

display_time = tk.Label(tk_root, font=(FONT_NAME, FONT_SIZE, FONT_STYLE), fg=FG_COLOR_DATE, bg=BG_COLOR_ROOT)
display_time.pack()

display_cur_temp = tk.Label(tk_root, font=(FONT_NAME, FONT_SIZE, FONT_STYLE), fg=FG_COLOR_WEATHER, bg=BG_COLOR_ROOT)
display_cur_temp.pack()

display_cur_wind = tk.Label(tk_root, font=(FONT_NAME, FONT_SIZE, FONT_STYLE), fg=FG_COLOR_WEATHER, bg=BG_COLOR_ROOT)
display_cur_wind.pack()

display_cur_pressure = tk.Label(tk_root, font=(FONT_NAME, FONT_SIZE, FONT_STYLE), fg=FG_COLOR_WEATHER, bg=BG_COLOR_ROOT)
...
def get_display_data():
    ...
    return( str_date, str_time, str_temp, str_humidity, str_wind, str_dirtxt, str_press, str_gust )
