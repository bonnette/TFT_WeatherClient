...
def get_display_data():
        ...
        if flag_debugging:
                logger("%s: DEBUG Display date = %s, time = %s, temp = %s F humidity = %s %% Speed = %s mph Dir = %s %s Gust = %s ",
                                MYNAME, str_date, str_time, str_temp, str_humidity, str_wind, str_dirtxt, str_press, str_gust)
#                print(flag_url)
#                print(str_press)
#                print(parsed_json)
